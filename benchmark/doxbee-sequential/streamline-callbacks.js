/*** Generated by streamline 0.10.15 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename, false),__func=__rt.__func,__cb=__rt.__cb,__catch=__rt.__catch,__tryCatch=__rt.__tryCatch; require("../lib/fakes");

function upload(stream, idOrPath, tag, _) { var blob, tx, blobId, file, previousId, splitPath, fileName, query; var __frame = { name: "upload", line: 3 }; return __func(_, this, arguments, upload, 3, __frame, function __$upload() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$upload() {
